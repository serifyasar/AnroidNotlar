...
class QuranQuizActivity : AppCompatActivity() {
    ...
    private fun kontrol() {
        ...
        if (word.meal==answer.text)
        {  txtDurum.text="Doğru"
            wordList.removeAt(0)

        }
        else
            txtDurum.text="Yanlış \nDoğru Cevap : " + word.meal
    ...
    private fun newQuestion() {
        ...
        optionList[0]=word.meal
        optionList[1]=answerList[0].meal
        optionList[2]=answerList[1].meal
        optionList[3]=answerList[2].meal

        diziShufle()
        question_tv.text=word.kuran
